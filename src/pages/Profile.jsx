    ...
    <div className="space-y-6 pb-10">
      ...
      <section className="rounded-3xl border border-slate-200/30 bg-white/60 p-8 shadow-soft backdrop-blur-md dark:border-white/[0.02] dark:bg-slate-950/40 relative overflow-hidden">
        ...
        <div className="flex items-center gap-2">
          ...
          <p className="text-[10px] font-bold uppercase tracking-[0.25em] text-indigo-650 dark:text-indigo-400">Account Details</p>
        </div>
        ...
        <div className="rounded-3xl border border-slate-200/30 bg-white/60 p-8 shadow-soft backdrop-blur-md dark:border-white/[0.02] dark:bg-slate-950/40 space-y-8">
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            ...
            <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-6 text-center dark:border-white/[0.02] dark:bg-slate-900/10 flex flex-col justify-center items-center relative group">
              <div className="relative h-24 w-24">
                {previewURL ? (
                  ...
                  <div className="flex h-24 w-24 items-center justify-center rounded-3xl bg-gradient-to-br from-indigo-500 to-purple-650 text-4xl font-extrabold text-white shadow-lg">
              ...
              <div className="mt-4 flex gap-2">
                <button
                  type="button"
                  onClick={() => fileInputRef.current?.click()}
                  className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 dark:bg-slate-900 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-slate-650 dark:text-slate-350 hover:bg-slate-200 dark:hover:bg-slate-800 transition"
                >
                ...
                {previewURL && (
                  <button
                    ...
                    className="inline-flex items-center gap-1.5 rounded-lg bg-rose-500/10 px-3 py-1.5 text-[10px] font-bold uppercase tracking-wider text-rose-650 dark:text-rose-400 hover:bg-rose-500/20 transition"
                  >
            ...
            <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-6 dark:border-white/[0.02] dark:bg-slate-900/10 space-y-4 flex flex-col justify-center">
              <div>
                <p className="flex items-center gap-2 text-[9px] font-black uppercase tracking-wider text-slate-450 dark:text-slate-500">
              ...
              <div>
                ...
                <p className="mt-1.5 text-xs font-semibold text-slate-650 dark:text-slate-350 truncate">
                  {user?.email}
                </p>
              </div>
              ...
              <div>
                ...
                <p className="mt-1.5 text-xs font-semibold text-slate-650 dark:text-slate-350">
          ...
          <form onSubmit={handleSubmit} className="rounded-2xl border border-slate-200/30 bg-white/40 p-6 dark:border-white/[0.02] dark:bg-slate-900/10 space-y-5">
            <div className="space-y-2">
              <label className="flex items-center gap-2 text-xs font-bold uppercase tracking-wider text-slate-450 dark:text-slate-500">
                <User className="h-3.5 w-3.5 text-indigo-500" />
                Display Name
              </label>
              <input
                ...
                className="w-full rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-sm font-semibold text-slate-750 outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-500/10 dark:border-slate-800 dark:bg-slate-950 dark:text-slate-100 dark:focus:border-indigo-400"
            ...
            <motion.button
              ...
              whileTap={{ scale: 0.99 }}
              className="rounded-xl bg-gradient-to-r from-indigo-500 to-purple-650 px-5 py-3 text-xs font-bold uppercase tracking-wider text-white shadow-lg shadow-indigo-500/20 transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-70"
            >
        ...
        <div className="rounded-3xl border border-slate-200/30 bg-white/60 p-8 shadow-soft backdrop-blur-md dark:border-white/[0.02] dark:bg-slate-950/40 space-y-6">
          ...
          <div className="space-y-4">
            <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-4 dark:border-white/[0.02] dark:bg-slate-900/10 flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-855 dark:text-white">Authentication Protocol</h4>
            ...
            <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-4 dark:border-white/[0.02] dark:bg-slate-900/10 flex items-start gap-3">
              ...
              <div>
                <h4 className="text-xs font-bold text-slate-855 dark:text-white">Profile status</h4>
