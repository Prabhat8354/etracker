      ...
      <section className="grid gap-6 xl:grid-cols-[1.25fr_0.75fr_0.8fr]">
          ...
          <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-[9px] font-black uppercase tracking-[0.25em] text-indigo-650 dark:text-indigo-400">Workspace</p>
              </div>
        ...
        >
          <div>
            <div className="flex items-center justify-between gap-4">
              ...
              <span className="rounded-lg bg-slate-100/60 dark:bg-slate-900/60 px-2 py-0.5 text-[9px] font-bold text-slate-650 dark:text-slate-350">
                {budgetProgress}% Used
              </span>
            </div>
            ...
            <div className="mt-6 space-y-4">
              <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-4.5 dark:border-white/[0.02] dark:bg-slate-900/10">
                <div className="flex items-center justify-between text-xs font-semibold text-slate-500 dark:text-slate-400">
                  ...
                  <span className="font-bold text-slate-850 dark:text-white">${monthlyBudget.toLocaleString()}</span>
                </div>
          ...
          <div className="rounded-2xl border border-slate-200/30 bg-white/40 p-4.5 dark:border-white/[0.02] dark:bg-slate-900/10 mt-4">
            ...
            <p className="mt-2 text-lg font-black text-slate-850 dark:text-white truncate">{topCategory}</p>
          </div>
        </motion.div>
        ...
        >
          <div className="flex items-center justify-between gap-4">
            ...
            <span className="rounded-lg bg-indigo-500/10 px-2 py-0.5 text-[9px] font-bold uppercase tracking-wider text-indigo-650 dark:text-indigo-400">
              {savingsProgress}% Met
            </span>
          </div>
          ...
          <div className="mt-6 flex items-center justify-around gap-4">
            ...
            <div className="relative flex items-center justify-center">
              ...
              <div className="absolute flex flex-col items-center">
                <span className="text-xs font-black text-slate-850 dark:text-white">{savingsProgress}%</span>
              </div>
            </div>
            ...
            <div className="space-y-3 shrink-0">
              ...
              <div>
                ...
                <p className="text-sm font-bold text-slate-850 dark:text-slate-350">
          ...
          <p className="mt-4 text-[10px] font-bold text-indigo-550 dark:text-indigo-400 flex items-center gap-1">
            <AlertCircle className="h-3 w-3" />
            {insights.savingsMsg}
          </p>
        </motion.div>
        ...
        <div className="rounded-3xl border border-slate-200/30 bg-white/60 p-8 shadow-soft backdrop-blur-md dark:border-white/[0.02] dark:bg-slate-950/40">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 rounded-xl bg-slate-900 px-4 py-2.5 text-xs font-bold uppercase tracking-wider text-white shadow-md hover:bg-slate-800 dark:bg-indigo-650 dark:hover:bg-indigo-600 transition duration-150"
            >
            ...
            {recentActivity.length ? (
              recentActivity.map((item, index) => (
                ...
                >
                  ...
                  <h4 className="mt-3.5 text-xs font-bold text-slate-850 dark:text-white truncate">{item.title}</h4>
                  <p className="mt-1 text-[9px] font-bold text-slate-400 dark:text-slate-550">{formatDate(item.date)}</p>
        ...
        <div className="rounded-3xl border border-slate-200/30 bg-white/60 p-8 shadow-soft backdrop-blur-md dark:border-white/[0.02] dark:bg-slate-950/40 space-y-5 flex flex-col justify-between">
          ...
          <div className="space-y-3.5">
            {upcomingBills.length ? (
              ...
              <p className="text-center text-xs font-semibold text-slate-400 dark:text-slate-550 py-4">No pending commitments.</p>
            )}
          </div>
        </div>
      </section>
